...
-- Type Accessoire
insert into type_accessoire (type_bonus, nom) values('attaque', 'Amulette de Puissance'),('defense', 'Bouclier de Résistance'),('vitesse', 'Bottes Agilité'),('endurance', 'Bague Endurance'),('attaque', 'Grimoire de Magie Noire'),('vitesse', 'Talisman de Rapidité'),('endurance', 'Collier Endurance'),('attaque', 'Arcane de Destruction'),('defense', 'Ecu de Protection'),('vitesse', 'Tunique de Vitesse');
-- Arme
